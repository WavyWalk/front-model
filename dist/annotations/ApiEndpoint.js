...
var ApiEndpointHandler = /** @class */ (function () {
    ...
    ApiEndpointHandler.prototype.produceUrl = function (caller, providedWilds, prefix) {
        if (this.urlPreparator.hasWilds) {
            var wildValues = this.populateWildValues(caller, providedWilds);
            return this.urlPreparator.produceUrl({ wildValues: wildValues, prefix: prefix });
        }
        else {
            return this.urlPreparator.produceUrl({ wildValues: null, prefix: prefix });
        }
    };
    ...
    return function (target, propertyName) {
        ...
        var requestFunction = function (options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var beforeRequestFunc, afterRequestFunc, rootResolve, rootReject, requestResult;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            if (!afterRequestFunc) return [3 /*break*/, 4];
                            return [4 /*yield*/, afterRequestFunc(options)];
